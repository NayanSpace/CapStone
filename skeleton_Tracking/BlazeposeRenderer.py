...
class BlazeposeRenderer:
	...
	#NEW: Angle caluaction check that those part of the body our visible before taking in values 
        if self.is_present(body, 12) and self.is_present(body, 14) and self.is_present(body, 16):
            shoulder = body.landmarks[12, :2]
